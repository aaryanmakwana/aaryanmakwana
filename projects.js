const projects = [
  ...
  {
    title: "SRM INDUCTANCE PROFILE GENERATOR",
  ...
  projects.forEach(project => {
    ...
    card.innerHTML = `
      ...
      <div class='project-info'>
        ...
        ${project.repo ? `<br><a href="${project.repo}" class="project-link">view code</a>` : ""}
      </div>
    `;
